...
void EXTERNAL_IRQ_0_init(void)
{
	...
	gpio_set_pin_direction(RFM_IRQ, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(RFM_IRQ,
	...
	gpio_set_pin_function(RFM_IRQ, PINMUX_PA09A_EIC_EXTINT9);
...
void system_init(void)
{
	...
	// Set pin direction to output
	gpio_set_pin_direction(RFM_CS, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(RFM_CS, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA08

	gpio_set_pin_function(RFM_RST, GPIO_PIN_FUNCTION_OFF);
